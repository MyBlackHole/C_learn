#include "ctype_learn.h"
#include <stddef.h>
#include <stdio.h>
#include <string.h>

static demo_t demos[] = {
	DEMO_MAIN_ITEM(isdigit_test), DEMO_MAIN_ITEM(islower_test),
	DEMO_MAIN_ITEM(isspace_test), DEMO_MAIN_ITEM(isxdigit_test),
	DEMO_MAIN_ITEM(tolower_test),
};
