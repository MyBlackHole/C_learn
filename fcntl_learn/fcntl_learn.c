...
static demo_t demos[] = {
    DEMO_MAIN_ITEM(splice),
    DEMO_MAIN_ITEM(splice1),
    DEMO_MAIN_ITEM(open),
    DEMO_MAIN_ITEM(open1),
    DEMO_MAIN_ITEM(file_flags),
    DEMO_MAIN_ITEM(fcntl),
    DEMO_MAIN_ITEM(WRLCK),
    DEMO_MAIN_ITEM(creat),
    DEMO_MAIN_ITEM(fallocate),
};
