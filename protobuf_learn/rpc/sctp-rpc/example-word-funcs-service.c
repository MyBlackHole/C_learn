...
static void implement_uppercase(Example__WordFuncs_Service *service,
...
static void implement_lowercase(Example__WordFuncs_Service *service,
				const Example__Word *input,
				Example__Word_Closure closure,
				void *closure_data)
{
...
Example__WordFuncs_Service example__word_funcs__service__global = {
	EXAMPLE__WORD_FUNCS__BASE_INIT, implement_uppercase,
	implement_lowercase
};
