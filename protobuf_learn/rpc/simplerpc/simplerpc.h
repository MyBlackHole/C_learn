...
#define __PROTOBUF_SIMPLERPC_H_

#include <protobuf-c/protobuf-c.h>

SimplerpcContext *simplerpc_context_new(void);
void simplerpc_context_add_service(SimplerpcServer *server, const char *domain,
				   ProtobufCService *service);

SimplerpcServer *simplerpc_bind_ipv4(int tcp_port, SimplerpcBindIpv4Flags flags,
...
ProtobufCService *
simplerpc_client_new_service(SimplerpcClient *client, const char *domain,
