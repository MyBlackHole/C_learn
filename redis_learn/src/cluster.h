...
#define REDIS_CLUSTER_PORT_INCR                  \
    10000 /* Cluster port = baseport + PORT_INCR \
           */
...
#define REDIS_CLUSTER_MF_TIMEOUT \
    5000 /* Milliseconds to do a manual failover. */
// 未使用，似乎已经废弃
...
struct clusterNode
{
    ...
    unsigned char
        slots[REDIS_CLUSTER_SLOTS / 8]; /* slots handled by this node */
