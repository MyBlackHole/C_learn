...
#define container(ptr, type, member) ({const typeof(((type *)0)->member) *__mptr = (ptr);(type *) ((char *)__mptr - offsetof(type,member));})


hash_tab *hash_tab_create(int size, hash_key_func hash_value, keycmp_func key_cmp, hash_node_free_func hash_node_free);
