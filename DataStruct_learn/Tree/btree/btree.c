    ...
    if (child->keynum == BTree_D - 1) {
      ...
      if ((leftSibling && leftSibling->keynum >= BTree_D) ||
        ...
        if (rightSibling && rightSibling->keynum >= BTree_D && richR) {
          ...
          rightSibling->child[rightSibling->keynum - 1] =
              rightSibling->child[rightSibling->keynum];
          ...
          --leftSibling->keynum;
                  ...
                  (leftSibling && leftSibling->keynum == BTree_D - 1)) &&
                 (!rightSibling ||
                  (rightSibling && rightSibling->keynum == BTree_D - 1))) {
