 ...
 *   第四章：文件和目录。
 *
 * 这里是 stat 函数和 lstat 函数的用法。 fstat 函数和 fstatat 函数用法类似 stat
 * 函数用法
 *
 */
#ifndef STAT_LSTAT
...
/*!
 * \brief print_file_time : 打印文件的最后访问时间、最后修改时间、 i
 * 节点状态的最后修改时间 \param pathname : 文件名
 */
 ...
 * \param pathname : 文件名
 * \return  : 如果指定文件名是目录，则返回 1 ; 如果该文件名不是目录，则返回 0;
 * 如果异常则返回 -1
 */
