...
static demo_t demos[] = {
    DEMO_MAIN_ITEM(getaddrinfo1),
    DEMO_MAIN_ITEM(getaddrinfo),
    DEMO_MAIN_ITEM(gethostbyaddr),
    DEMO_MAIN_ITEM(gethostbyname),
    DEMO_MAIN_ITEM(getnameinfo),
    DEMO_MAIN_ITEM(getnameinfo1),
};
