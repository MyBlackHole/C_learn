...
int demo_lz4_main(void)
{
    ...
    const char * const src = "/gaussdb/data/my_tbs/PG_9.2_201611171_dn_6001_6002_6003/18710/18714_fsm";
    ...
    if (write(STDOUT_FILENO, compressed_data, compressed_data_size) != compressed_data_size) {
