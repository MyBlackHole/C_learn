...
int main(int argc, char const *argv[])
{
	...
	care_taker_add_memento(care_taker,
			       originator_save_state_to_memento(originator));
	...
	originator_get_state_from_memento(
		originator, care_taker_get_memento(care_taker, 0));
	printf("First saved State: %s\n", originator_get_state(originator));
	originator_get_state_from_memento(
		originator, care_taker_get_memento(care_taker, 1));
