...
{
	DependentObject2 *dependent_object2 =
		(DependentObject2 *)calloc(1, sizeof(DependentObject2));
	return dependent_object2;
}

void dependent_object2_destroy(DependentObject2 **dependent_object2)
{
	if (NULL == dependent_object2 || NULL == *dependent_object2)
		return;
