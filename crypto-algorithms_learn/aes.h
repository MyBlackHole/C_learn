...
int aes_encrypt_ccm(
    ...
    const BYTE associated_data[], // IN  - Associated Data included in
                                  // authentication, but not encryption.
    unsigned short
        associated_data_len,  // IN  - Associated Data length in bytes.
    const BYTE nonce[],       // IN  - The Nonce to be used for encryption.
    unsigned short nonce_len, // IN  - Nonce length in bytes.
    BYTE ciphertext[], // OUT - Ciphertext, a concatination of the plaintext and
                       // the MAC.
    WORD *ciphertext_len, // OUT - The length of the ciphertext, always
...
int aes_decrypt_ccm(
    const BYTE ciphertext[], // IN  - Ciphertext, the concatination of encrypted
                             // plaintext and MAC.
    ...
    const BYTE nonce[], // IN  - The Nonce to use for decryption, same one as
                        // for encryption.
    unsigned short nonce_len, // IN  - Nonce length in bytes.
    BYTE plaintext[], // OUT - The plaintext that was decrypted. Will need to be
