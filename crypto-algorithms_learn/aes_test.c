...
int aes_ctr_test()
{
	...
	BYTE plaintext[1][32] = { { 0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f,
				    ...
				    0x03, 0xac, 0x9c, 0x9e, 0xb7, 0x6f, 0xac,
				    0x45, 0xaf, 0x8e, 0x51 } };
	BYTE ciphertext[1][32] = { { 0x60, 0x1e, 0xc3, 0x13, 0x77, 0x57, 0x89,
...
int aes_ccm_test()
{
	...
	BYTE iv[3][16] = { { 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16 },
			   ...
			   { 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
			     0x18, 0x19, 0x1a, 0x1b } };
	BYTE key[1][32] = { { 0x40, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47,
